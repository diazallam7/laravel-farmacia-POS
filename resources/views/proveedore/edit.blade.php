...
@section('content')
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item"><a href="{{ route('clientes.index') }}">Proveedor</a></li>
            ...
            <form action="{{ route('proveedores.update',['proveedore'=>$proveedore]) }}" method="post">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12 mb-2" id="box-razon-social">
                        @if ($proveedore->persona->razon_social == 'natural')
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="documento_id" id="docuemnto_id">
                            ...
                            @if ($proveedore->persona->documento->id == $item->id)
