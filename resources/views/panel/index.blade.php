            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-success text-white mb-4">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                <i class="fa-solid fa-cart-shopping"></i><span class="m-1">Venta</span>
                            </div>
                            <div class="col-4">
                                <?php
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-secondary text-white mb-4">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                <i class="fa-solid fa-code-branch"></i><span class="m-1">Marcas</span>
                            </div>
                            <div class="col-4">
                                <?php
            ...
            <div class="col-xl-3 col-md-8">
                <div class="card bg-primary text-white mb-4">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                <i class="fa-solid fa-dollar-sign"></i><span class="m-1">Pagos</span>
                            </div>
                            <div class="col-4">
